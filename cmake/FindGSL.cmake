...
if( WIN32 AND NOT CYGWIN AND NOT MSYS )
  ...
  if( UNIX OR MSYS )
    ...
    if( GSL_CONFIG_EXECUTABLE )
      ...
      if( GSL_USE_EXTERNAL_CBLAS )
        set(GSL_CONFIG_LIBS_FLAG --libs-without-cblas )
      else( GSL_USE_EXTERNAL_CBLAS )
        set(GSL_CONFIG_LIBS_FLAG --libs )
      endif( GSL_USE_EXTERNAL_CBLAS )


      # run the gsl-config program to get the libs
      execute_process(
        COMMAND sh "${GSL_CONFIG_EXECUTABLE}" ${GSL_CONFIG_LIBS_FLAG}
